             ...
             <List aria-label="products" className="flex pt-10 bg-zinc-50">
                <ListItem disablePadding className="flex hover:bg-orange-300 -mt-2">
                  ...
                  <ListItemButton className="w-screen flex shadow-inner">
                          <ListItemText
                          className="w-auto flex-nowrap text-justify"
                          inset primary={result.name + " ("+ result.category + ")"} />
                          <ListItemText primaryTypographyProps={{fontSize: '14px'}}
                          className="w-auto flex-nowrap ml-3 text-orange-800  text-right pr-20"
                          primary={result.price + " " + result.currency}/>
                      </ListItemButton>
                    </Link>
                </ListItem>
          </List>
